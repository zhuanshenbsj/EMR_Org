 ...
 * 类描述：暂无 
 * 创建人：lw   
 * 创建时间：2014-3-25 上午09:56:27   
 * 修改人：lw   
 * 修改时间：2014-3-25 上午09:56:27   
 * 修改备注： 
 * @version
 */
public class ImageUtils {
	...
	public static void main(String[] args) {
		...
		// 方法二：按高度和宽度缩放
		ImageUtils.scale2("e:/img/abc.jpg", "e:/img/abc_scale2.jpg", 500, 300,
				true);// 测试OK
		...
		// 5-给图片添加文字水印：
		// 方法一：
		ImageUtils.pressText("我是水印文字", "e:/img/abc.jpg",
				"e:/img/abc_pressText.jpg", "宋体", Font.BOLD, Color.white, 80,
				0, 0, 0.5f);// 测试OK
		// 方法二：
		ImageUtils.pressText2("我也是水印文字", "e:/img/abc.jpg",
				"e:/img/abc_pressText2.jpg", "黑体", 36, Color.white, 80, 0, 0,
				0.5f);// 测试OK

		// 6-给图片添加图片水印：
		ImageUtils.pressImage("e:/img/abc2.jpg", "e:/img/abc.jpg",
